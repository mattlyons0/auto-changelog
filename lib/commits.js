      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            command = branch ? "git log --merges ".concat(branch) : 'git log --merges';
            _context.next = 5;
            return getLogFormat();
...
function parseCommits(_x3, _x4) {
  return _parseCommits.apply(this, arguments);
}

function _parseCommits() {
  _parseCommits = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(string, remote) {
    var options,
        commits,
        index,
        _args3 = arguments;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            commits = string.split(COMMIT_SEPARATOR).slice(1).map(function (commit) {
              return parseMergeCommit(commit, remote, options);
            });
            _context3.next = 4;
          ...
          case 4:
            ...
            commits.flat() // parseCommit may return an array, flatten that
            ...
            index = commits.findIndex(function (c) {
          ...
          case 10:
            return _context3.abrupt("return", commits.slice(0, index + 1));
...
function parseMergeCommit(_x5, _x6) {
  return _parseMergeCommit.apply(this, arguments);
}

function _parseMergeCommit() {
  _parseMergeCommit = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(commit, remote) {
    var options,
        _commit$match3,
        _commit$match4,
        hash,
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _commit$match3 = commit.match(MATCH_COMMIT), _commit$match4 = _slicedToArray(_commit$match3, 7), hash = _commit$match4[1], refs = _commit$match4[2], date = _commit$match4[3], author = _commit$match4[4], email = _commit$match4[5], tail = _commit$match4[6];
            command = "git log \"".concat(hash, "^..").concat(hash, "\" --no-merges");
            _context4.next = 5;
            return getLogFormat();

          case 5:
            format = _context4.sent;
            _context4.next = 8;
            return (0, _utils.cmd)("".concat(command, " --shortstat --pretty=format:").concat(format));

          case 8:
            log = _context4.sent;
            console.log(log);
            commits = commit.split(COMMIT_SEPARATOR).slice(1).map(function (commit) {
